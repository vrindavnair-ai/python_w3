...
#Metric - Return the specified unit in meter (e.g. centi returns 0.01)
...
#Binary - Return the specified unit in bytes (e.g. kibi returns 1024)
...
#Legth - Return the specified unit in meters (e.g. nautical_mile returns 1852.0)
...
#Energy - specified unit in joules (e.g. calorie returns 4.184)
...
mat = csr_matrix(arr)
mat.eliminate_zeros() #Removing zero entires
